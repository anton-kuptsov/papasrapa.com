    ...
    <section className={style.container}>
      ...
      <div className={style.wrapper}>
        ...
        <Decoration
          ...
          {...SQUARE}
          bgColor="#fff705"
          css="--z-index: -1; transform: rotate(45deg);"
        />
        <Decoration
          left="288px"
          top="485px"
        ...
        <div className={style.title + " " + style.title_bottom}>
          Дзига Вертов
        </div>
